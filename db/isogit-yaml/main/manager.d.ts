...
declare class Manager<M extends Model, IDType extends AnyIDType, Q extends object = object> extends ModelManager<M, IDType, Q> implements FilesystemManager {
    private db;
    private managerConfig;
    private modelInfo;
    private reportUpdatedData;
    ...
    readAll(): Promise<Record<string, M>>;
